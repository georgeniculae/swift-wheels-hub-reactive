...
@Component
@Slf4j
public class LanguageHeaderUpdaterFilter extends AbstractGatewayFilterFactory<LanguageHeaderUpdaterFilter.LanguageConfig> {

    private static final String LANGUAGE = "Language";

    public LanguageHeaderUpdaterFilter() {
