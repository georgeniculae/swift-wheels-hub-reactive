...
@RouterOperations(
        {
                ...
                @RouterOperation(method = RequestMethod.PUT, path = "/{id}/set-car-not-available", params = "id", beanClass = CarService.class, beanMethod = "updateCarStatus"),
                @RouterOperation(method = RequestMethod.PUT, path = "/{id}/update-after-return", params = "id", beanClass = CarService.class, beanMethod = "updateCarWhenBookingIsClosed"),
                @RouterOperation(method = RequestMethod.PUT, path = "/{id}", params = "id", beanClass = CarService.class, beanMethod = "updateCar"),
                @RouterOperation(method = RequestMethod.DELETE, path = "/{id}", params = "id", beanClass = CarService.class, beanMethod = "deleteCarById"),
        }
)
