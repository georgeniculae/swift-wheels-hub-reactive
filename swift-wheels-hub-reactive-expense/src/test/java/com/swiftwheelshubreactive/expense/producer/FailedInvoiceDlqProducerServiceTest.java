...
class FailedInvoiceDlqProducerServiceTest {
    ...
    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(failedInvoiceDlqProducerService, "binderName", "failedInvoiceDlqProducer");
        ReflectionTestUtils.setField(failedInvoiceDlqProducerService, "mimeType", "application/json");
    }
    ...
    void reprocessInvoiceTest_success() {
        ...
        failedInvoiceDlqProducerService.reprocessInvoice(invoiceReprocessRequest)
